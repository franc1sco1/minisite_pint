...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // No JavaScript interference - links work natively
    console.log('Access links are now fully functional');
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (userInput.join('') === konamiCode.join('')) {
            showNotification('🎉 Easter Egg descoberto! Parabéns à equipa PINT!', 'success');
...
console.log('🎓 PINT - Plataforma Integrada de Formação');
console.log('🚀 Microsite carregado com sucesso!');
console.log('👥 Desenvolvido por: António, David, Francisco, José e Nuno');
